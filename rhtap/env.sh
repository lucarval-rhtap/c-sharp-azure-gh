...
export IMAGE_URL=${IMAGE_URL-quay.io/lucarval-rhtap/c-sharp-azure-gh:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/lucarval-rhtap/c-sharp-azure-gh-gitops
